...
(async () => {
  console.log("Launching browser for Google Flights OneWay...");
  ...
  try {
    ...
    // Add oneway to query
    const url = 'https://www.google.com/travel/flights?q=Flights%20from%20HAN%20to%20SGN%20on%202026-07-25%20oneway';
    await page.goto(url, { waitUntil: 'networkidle2', timeout: 60000 });
    
    console.log("Waiting for results to load...");
    await new Promise(r => setTimeout(r, 10000)); // Wait 10s
    
    await page.screenshot({ path: path.join(ARTIFACT_DIR, '29_google_flights_oneway.png') });
    console.log("Screenshot 29 saved.");
