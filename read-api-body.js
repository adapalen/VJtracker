  ...
  try {
    ...
    page.on('response', async (response) => {
      ...
      if (url.includes('search-flight')) {
        ...
        console.log(`[Response Received] URL: ${url} | Method: ${method} | Status: ${response.status()}`);
        if (method === 'PATCH') {
          try {
            ...
            console.log("Error reading PATCH response body:", err.message);
          }
        }
      }
    });
    ...
    // Select Date: July 20, 2026 (5 days out)
    console.log("Selecting July 20, 2026...");
    await page.evaluate(() => {
